...
public class MapMetadataExtractor {
    ...
    public static MapInfo extractMapInfo(File mapFile) {
        try {
            // Aqui necesitariamos usar UnrealPackage de L2smr
            // Por ahora simulamos la extraccion basandose en el nombre del archivo
            
            String fileName = mapFile.getName();
            String nameWithoutExt = fileName.substring(0, fileName.lastIndexOf('.'));
            
            // Intentar extraer coordenadas del nombre del archivo (formato: X_Y.unr)
            ...
            // Si no se puede extraer del nombre, intentar extraer del archivo
            // TODO: Implementar extraccion real usando UnrealPackage
            return new MapInfo(fileName, 0, 0, false);
            
        } catch (Exception ignored) {
            return new MapInfo(mapFile.getName(), 0, 0, false);
        }
    }
