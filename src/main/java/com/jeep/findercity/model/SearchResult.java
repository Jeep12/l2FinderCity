...
public class SearchResult {
    ...
    private List<StaticMeshActorMatch> foundActors;
    ...
    public SearchResult() {
        ...
        this.foundActors = new ArrayList<>();
        this.found = false;
    }
    ...
    public void addFoundActor(StaticMeshActorMatch actor) {
        this.foundActors.add(actor);
        this.found = true;
    }
    
    public List<StaticMeshActorMatch> getFoundActors() {
        return foundActors;
    }
    ...
    public String toString() {
        ...
        if (found) {
            ...
            if (!foundActors.isEmpty()) {
                sb.append("\n=== DETALLES DE STATICMESHACTORS ENCONTRADOS ===\n");
                for (StaticMeshActorMatch actor : foundActors) {
